...
export default function ClientesPage() {
  ...
  // Cargar clientes del técnico (solo clientes con los que ha trabajado)
  useEffect(() => {
    const loadClientes = async () => {
      try {
        ...
        console.log('Response from /api/dashboard/clientes:', data)

        if (data.success && data.data) {
          // Backend returns { total, clientes: [...] }
          const clientesArray = Array.isArray(data.data.clientes) ? data.data.clientes : []
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      ...
                      <div className="text-center">
                        <p className="text-2xl font-black text-gray-900">
                          {cliente.calificacionPromedio > 0 ? Number(cliente.calificacionPromedio).toFixed(1) : 'N/A'}
                        </p>
